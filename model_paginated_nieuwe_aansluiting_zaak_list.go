...
// PaginatedNieuweAansluitingZaakList struct for PaginatedNieuweAansluitingZaakList
type PaginatedNieuweAansluitingZaakList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []NieuweAansluitingZaak `json:"results,omitempty"`
}
...
func NewPaginatedNieuweAansluitingZaakList() *PaginatedNieuweAansluitingZaakList {
	this := PaginatedNieuweAansluitingZaakList{}
	return &this
}
...
func (o *PaginatedNieuweAansluitingZaakList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedNieuweAansluitingZaakList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []NieuweAansluitingZaak and assigns it to the Results field.
func (o *PaginatedNieuweAansluitingZaakList) SetResults(v []NieuweAansluitingZaak) {
	o.Results = v
}

func (o PaginatedNieuweAansluitingZaakList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedNieuweAansluitingZaakList struct {
	value *PaginatedNieuweAansluitingZaakList
	isSet bool
}

func (v NullablePaginatedNieuweAansluitingZaakList) Get() *PaginatedNieuweAansluitingZaakList {
	return v.value
}

func (v *NullablePaginatedNieuweAansluitingZaakList) Set(val *PaginatedNieuweAansluitingZaakList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedNieuweAansluitingZaakList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedNieuweAansluitingZaakList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedNieuweAansluitingZaakList(val *PaginatedNieuweAansluitingZaakList) *NullablePaginatedNieuweAansluitingZaakList {
	return &NullablePaginatedNieuweAansluitingZaakList{value: val, isSet: true}
}

func (v NullablePaginatedNieuweAansluitingZaakList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedNieuweAansluitingZaakList) UnmarshalJSON(src []byte) error {
	v.isSet = true
