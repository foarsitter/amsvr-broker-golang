...
// PaginatedAanwezigCriteriumList struct for PaginatedAanwezigCriteriumList
type PaginatedAanwezigCriteriumList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []AanwezigCriterium `json:"results,omitempty"`
}
...
func NewPaginatedAanwezigCriteriumList() *PaginatedAanwezigCriteriumList {
	this := PaginatedAanwezigCriteriumList{}
	return &this
}
...
func (o *PaginatedAanwezigCriteriumList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAanwezigCriteriumList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []AanwezigCriterium and assigns it to the Results field.
func (o *PaginatedAanwezigCriteriumList) SetResults(v []AanwezigCriterium) {
	o.Results = v
}

func (o PaginatedAanwezigCriteriumList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAanwezigCriteriumList struct {
	value *PaginatedAanwezigCriteriumList
	isSet bool
}

func (v NullablePaginatedAanwezigCriteriumList) Get() *PaginatedAanwezigCriteriumList {
	return v.value
}

func (v *NullablePaginatedAanwezigCriteriumList) Set(val *PaginatedAanwezigCriteriumList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAanwezigCriteriumList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAanwezigCriteriumList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAanwezigCriteriumList(val *PaginatedAanwezigCriteriumList) *NullablePaginatedAanwezigCriteriumList {
	return &NullablePaginatedAanwezigCriteriumList{value: val, isSet: true}
}

func (v NullablePaginatedAanwezigCriteriumList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAanwezigCriteriumList) UnmarshalJSON(src []byte) error {
	v.isSet = true
