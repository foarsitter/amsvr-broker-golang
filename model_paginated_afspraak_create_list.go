...
// PaginatedAfspraakCreateList struct for PaginatedAfspraakCreateList
type PaginatedAfspraakCreateList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []AfspraakCreate `json:"results,omitempty"`
}
...
func NewPaginatedAfspraakCreateList() *PaginatedAfspraakCreateList {
	this := PaginatedAfspraakCreateList{}
	return &this
}
...
func (o *PaginatedAfspraakCreateList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAfspraakCreateList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []AfspraakCreate and assigns it to the Results field.
func (o *PaginatedAfspraakCreateList) SetResults(v []AfspraakCreate) {
	o.Results = v
}

func (o PaginatedAfspraakCreateList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAfspraakCreateList struct {
	value *PaginatedAfspraakCreateList
	isSet bool
}

func (v NullablePaginatedAfspraakCreateList) Get() *PaginatedAfspraakCreateList {
	return v.value
}

func (v *NullablePaginatedAfspraakCreateList) Set(val *PaginatedAfspraakCreateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAfspraakCreateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAfspraakCreateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAfspraakCreateList(val *PaginatedAfspraakCreateList) *NullablePaginatedAfspraakCreateList {
	return &NullablePaginatedAfspraakCreateList{value: val, isSet: true}
}

func (v NullablePaginatedAfspraakCreateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAfspraakCreateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
