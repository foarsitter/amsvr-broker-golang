...
// PaginatedCriteriumList struct for PaginatedCriteriumList
type PaginatedCriteriumList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []Criterium `json:"results,omitempty"`
}
...
func (o *PaginatedCriteriumList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedCriteriumList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Criterium and assigns it to the Results field.
func (o *PaginatedCriteriumList) SetResults(v []Criterium) {
	o.Results = v
}

func (o PaginatedCriteriumList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedCriteriumList struct {
	value *PaginatedCriteriumList
	isSet bool
}

func (v NullablePaginatedCriteriumList) Get() *PaginatedCriteriumList {
	return v.value
}

func (v *NullablePaginatedCriteriumList) Set(val *PaginatedCriteriumList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCriteriumList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCriteriumList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCriteriumList(val *PaginatedCriteriumList) *NullablePaginatedCriteriumList {
	return &NullablePaginatedCriteriumList{value: val, isSet: true}
}

func (v NullablePaginatedCriteriumList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCriteriumList) UnmarshalJSON(src []byte) error {
	v.isSet = true
