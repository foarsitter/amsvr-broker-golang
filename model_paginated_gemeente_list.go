...
func (o *PaginatedGemeenteList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedGemeenteList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Gemeente and assigns it to the Results field.
func (o *PaginatedGemeenteList) SetResults(v []Gemeente) {
	o.Results = v
}

func (o PaginatedGemeenteList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedGemeenteList struct {
	value *PaginatedGemeenteList
	isSet bool
}

func (v NullablePaginatedGemeenteList) Get() *PaginatedGemeenteList {
	return v.value
}

func (v *NullablePaginatedGemeenteList) Set(val *PaginatedGemeenteList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGemeenteList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGemeenteList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGemeenteList(val *PaginatedGemeenteList) *NullablePaginatedGemeenteList {
	return &NullablePaginatedGemeenteList{value: val, isSet: true}
}

func (v NullablePaginatedGemeenteList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGemeenteList) UnmarshalJSON(src []byte) error {
	v.isSet = true
