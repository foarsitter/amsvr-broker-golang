...
// PaginatedContactPersoonList struct for PaginatedContactPersoonList
type PaginatedContactPersoonList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ContactPersoon `json:"results,omitempty"`
}
...
func NewPaginatedContactPersoonList() *PaginatedContactPersoonList {
	this := PaginatedContactPersoonList{}
	return &this
}
...
func (o *PaginatedContactPersoonList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedContactPersoonList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ContactPersoon and assigns it to the Results field.
func (o *PaginatedContactPersoonList) SetResults(v []ContactPersoon) {
	o.Results = v
}

func (o PaginatedContactPersoonList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedContactPersoonList struct {
	value *PaginatedContactPersoonList
	isSet bool
}

func (v NullablePaginatedContactPersoonList) Get() *PaginatedContactPersoonList {
	return v.value
}

func (v *NullablePaginatedContactPersoonList) Set(val *PaginatedContactPersoonList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedContactPersoonList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedContactPersoonList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedContactPersoonList(val *PaginatedContactPersoonList) *NullablePaginatedContactPersoonList {
	return &NullablePaginatedContactPersoonList{value: val, isSet: true}
}

func (v NullablePaginatedContactPersoonList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedContactPersoonList) UnmarshalJSON(src []byte) error {
	v.isSet = true
