...
// PaginatedMeldkamerList struct for PaginatedMeldkamerList
type PaginatedMeldkamerList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []Meldkamer `json:"results,omitempty"`
}
...
func (o *PaginatedMeldkamerList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedMeldkamerList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Meldkamer and assigns it to the Results field.
func (o *PaginatedMeldkamerList) SetResults(v []Meldkamer) {
	o.Results = v
}

func (o PaginatedMeldkamerList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedMeldkamerList struct {
	value *PaginatedMeldkamerList
	isSet bool
}

func (v NullablePaginatedMeldkamerList) Get() *PaginatedMeldkamerList {
	return v.value
}

func (v *NullablePaginatedMeldkamerList) Set(val *PaginatedMeldkamerList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedMeldkamerList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedMeldkamerList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedMeldkamerList(val *PaginatedMeldkamerList) *NullablePaginatedMeldkamerList {
	return &NullablePaginatedMeldkamerList{value: val, isSet: true}
}

func (v NullablePaginatedMeldkamerList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedMeldkamerList) UnmarshalJSON(src []byte) error {
	v.isSet = true
